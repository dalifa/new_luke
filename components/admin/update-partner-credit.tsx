// AGMENTER LE PARTNER CREDIT D'UN PARTNER 
"use client"; 
...
const UpdatePartnerCredit = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.patch("/api/admin/update-partner-credit", values);
...
export default UpdatePartnerCredit