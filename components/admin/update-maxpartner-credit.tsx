// UPDATER LE MAXPARTNER CREDIT D'UN PARTNER 
"use client"; 
...
const MaxPartnerCredit = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.patch("/api/admin/update-maxpartner-credit", values);
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-6 px-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                  <FormItem>
                    <FormLabel>partner code pin</FormLabel>
                    <FormControl>
                      <Input
                      type="number"
                        disabled={isLoading}
...
export default MaxPartnerCredit