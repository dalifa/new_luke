...
import { justDonatorInSnippets } from "@/actions/snippets/just-donator";

export function AlsoReceiverInSnippets({ collectionId }: { collectionId: string }) {
  const alsoReceiverId = justDonatorInSnippets.bind(null, collectionId)
  //
