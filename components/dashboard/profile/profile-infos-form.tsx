...
const formSchema = z.object({
  ...
  phone: z.string().toLowerCase().max(10, {
    message: "Votre portable."
  }),
...
export const ProfileInfosForm : React.FC <ProfileProps> = ({
  ...
  const form = useForm<ProfileFormValues>({
    ...
    defaultValues: initialData || {
      username: "",
      phone: "",  // il faut mettre un chiffre quand c'est un Int sinon erreur
      firstname: "",
      lastname: "",
      city: "",
      countryId: "",
  ...
  return (
    <div className="flex w-full m-8 md:w-3/5 mt-5 ">
      <div className="bg-white rounded p-0 md:p-5 w-full shadow-md mx-8 shadow-slate-300">
        
        <div className=" flex  flex-col pt-5 px-6 items-center justify-center">
          <div className="text-md lg:text-lg text-black text-center font-bold mb-10">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        disabled={isLoading}
                        className="bg-blue-100/50 text-xs border-0 focus-visible:ring-0 text-black focus-visible:ring-offset-0"
                        placeholder="Pseudo"
                        {...field}
                      />
                    </FormControl>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                      <FormControl>
                        <SelectTrigger className="bg-blue-100/50 text-xs border-0 focus-visible:ring-0 text-black focus-visible:ring-offset-0">
            ...
            <div className="px-4 pb-10 rounded border-8 border-white">
              <Button variant={"primary"} disabled={isLoading} className="w-full h-12 md:h-14 text-xl text-white">
                Enregistrer
              </Button>
            </div>
          </form>
