...
const formSchema = z.object({
    amountToTransfer: z.coerce.number().min(1, {
    message: "Entrez le montant à transférer"
  }),
});

const JackpotToCreditForm = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.patch("/api/profile/transfer-jackpot-to-credit", values);
...
export default JackpotToCreditForm