...
const formSchema = z.object({
  ...
  phone: z.coerce.number().min(1, {
    message: "Entrez le numéro de portable"
  }),
...
export const ProfileForm : React.FC <ProfileProps> = ({
  ...
  const form = useForm<ProfileFormValues>({
    ...
    defaultValues: initialData || {
      username: "",
      phone: 0,  // il faut mettre un chiffre parce que c'est un Int sinon erreur
      firstname: "",
      lastname: "",
      city: "",
      countryId: "",
    ...
    <div className="flex w-full m-8 md:w-3/5 mt-5 ">
      <div className="bg-white rounded p-0 md:p-5 w-full shadow-md mx-8 shadow-slate-300">
        ...
        <div className=" flex  flex-col pt-5 px-6 items-center justify-center">
          <div className="text-lg md:text-xl text-slate-500 text-center font-bold mb-10">
