...
//
export default function AmountTwoDialog({ amountId }: { amountId: string }) {
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="blue">10€</Button>
      </DialogTrigger>
      <DialogContent className="w-4/5 md:w-3/5 rounded-md">
        <DialogHeader className="flex gap-y-4">
          <DialogTitle className="text-center text-blue-600">
            Confirmer vouloir donner 10€
          </DialogTitle>
