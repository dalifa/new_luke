...
import { connectedAmountOne, connectedAmountThree, currentUserInfos } from "@/hooks/own-current-user";
...
export const amountThreeTotalityEnterAction = async () => {
        ...
        { 
          ...
          await prismadb.activity.create({
            data: {
              ...
              action: "entrée dans une collecte totality de : " + myAmountThree?.amount + myAmountThree?.currency + " de " + metrics.tcg + " participants."  // Json?
            }
          })
          // ##
