...
import { connectedAmountFour, currentUserInfos } from "@/hooks/own-current-user";
...
export const amountSevenTotalityEnterAction = async () => {
        ...
        { 
          ...
          await prismadb.activity.create({
            data: {
              ...
              action: "entrée dans une collecte totality de : " + myAmountFour?.amount + myAmountFour?.currency + " de " + metrics.tcg + " participants."  // Json?
            }
          })
          // ##
