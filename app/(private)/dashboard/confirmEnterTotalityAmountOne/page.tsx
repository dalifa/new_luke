...
import { AmountOneTotalityCollectionEnter } from "@/components/dashboard/enter-in-collection/amountOne-totality-collectionEnter"
...
const confirmEnterTotalityAmountOne = async () => {
    // en prod 
            ...
            <div className='flex w-full p-4 md:w-2/5 items-center justify-center flex-col'>
                <Card className='w-full mt-20 p-5 bg-white text-blue-800 items-center shadow-slate-300 shadow-lg'>
                    ...
                    <CardDescription className="mb-10 text-slate-500 text-sm lg:text-md text-center leading-relaxed">
                        Confirmez-vous votre entrée dans une collecte Totality de {myAmountOne?.amount}{myAmountOne?.currency} ?
                    </CardDescription>
                    
                    <div className="grid grid-cols-2 gap-x-5">
                        <BackCancel/>
                        <AmountOneTotalityCollectionEnter>
                          Confirmer
                        </AmountOneTotalityCollectionEnter>
                    </div>
                </Card>
...
export default confirmEnterTotalityAmountOne
