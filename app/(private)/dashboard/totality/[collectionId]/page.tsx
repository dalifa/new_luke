  ...
  return (
    <div className='h-full flex items-center justify-center flex-col pt-10 gap-5 bg-white'>
      <div className='w-4/5 lg:w-2/5 p-3 border rounded text-center bg-white shadow-md shadow-blue-100'>
        <p className='text-blue-500 text-center text-md lg:text-lg'>
          Participants à votre collecte Totality n° {theParams?.ownId} de {theParams?.amount}{theParams?.currency}
        </p>
      </div>
      <div className='w-4/5'>
        {
                                            ...
                                            participant?.usercodepin === connectedParticipant?.usercodepin && (
                                              <>
                                              {
                                                hasGive < participant?.group && (
                                                  <Link href={`/dashboard/totality/${params.collectionId}/project/${participant.id}`}>
                                    ...
                                    profileData.usercodepin !== connectedProfile?.usercodepin ? (
                                                ...
                                                <>
                                                  {
                                                    connectedParticipant?.hasGive === false ? (
                                                      <Link href={`/dashboard/totality/${params.collectionId}/${participant.id}`}>
                                      ...
                                      <div className='text-sm'>
                                        { 
                                          ...
                                          <>
                                            <p className='pb-1'>Vous avez désigné &nbsp; <span className='font-medium text-violet-800'>{ recipientProfile?.username }</span></p>
                                            <p className=''> 
                                              <span className='text-green-600'>{hasGive}</span>
                                              &nbsp;/&nbsp; {participant?.group} { hasGive < 2 ? (
