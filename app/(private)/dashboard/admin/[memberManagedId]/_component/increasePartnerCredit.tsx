'use client'
import { increasePartnerCredit } from '@/actions/admin/increase_partner_credit';
//
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { useRef, useState } from 'react';
//
export function IncreasePartnerCredit({ memberManagedId }: { memberManagedId: string }) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    //
    try {
      await increasePartnerCredit(memberManagedId, formData);
