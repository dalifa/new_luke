...
import { increasePartnerMaxCredit } from '@/actions/admin/increase_partner_max_credit';
//
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { useRef, useState } from 'react';
//
export function IncreasePartnerMaxCredit({ memberManagedId }: { memberManagedId: string }) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    //
    try {
      await increasePartnerMaxCredit(memberManagedId, formData);
  ...
  return (
    ...
    >
      <p className="text-white text-center text-xl font-medium">Max Partner Credit</p>
