...
export default function Home() {
  return (
    <div className="flex w-full h-full items-center justify-center flex-col bg-blue-500 text-white p-4 md:p-5 border-t-2 border-white ">
      <div className="flex w-full lg:w-3/5 items-center justify-center flex-col px-10">
        ...
        <div className="flex flex-col">
          <p className="text-lg lg:text-3xl text-justify leading-relaxed mb-2">Donnez aux autres et Dieu vous donnera (à travers les autres): on
        ...
        <div className="flex w-full items-center justify-center mt-5">
          <Link href={"/home"} className="w-full text-center">
            <Button variant="blue" className="w-full h-10 lg:h-20 text-md md:text-xl font-semibold border-2 border-white">
              AMEN !
            </Button>
          </Link>
        </div>
